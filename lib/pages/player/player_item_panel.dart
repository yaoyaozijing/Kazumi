                  ...
                  children: [
                    ...
                    MenuAnchor(
                      ...
                      builder: (BuildContext context, MenuController controller,
                          Widget? child) {
                        final currentLabel = superResolutionTypeMap[
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: Slider(
                                      min: 0,
                                      max: (defaultPlaySpeedList.length - 1)
                                          .toDouble(),
                                      divisions:
                                          defaultPlaySpeedList.length - 1,
                                  ...
                                  for (final speed in const [
                                    ...
                                    ActionChip(
                                      ...
                                      labelStyle: TextStyle(
                                        color: (playerController.playerSpeed -
                                                        speed)
                                                    .abs() <
                                                0.001
                                            ? Theme.of(context)
          ...
          child: MouseRegion(
            ...
            child: Row(
              children: [
                ...
                SizedBox(
                  width:
                      _needDesktopOverlayInset ? _desktopRightOverlayInset : 0,
                ),
              ],
            ),
          ),
